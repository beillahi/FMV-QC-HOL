...
let FLip_In_Output = define 
`FLip_In_Output ((x0:sm), (y0:sm),(a:sm^N), (c1:sm^N), 
...
let FLIP_GATE = new_definition 
`FLIP_GATE ((x0:sm), (y0:sm), 
...
FLip_In_Output (x0,y0,a, d, LH, LV)) `;;
...
IMP_REWRITE_TAC[FLip_In_Output] THEN  
